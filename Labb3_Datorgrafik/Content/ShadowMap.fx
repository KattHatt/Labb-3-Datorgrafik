...
VertexToPixel FirstVertexShader(float4 inPos : POSITION0, float3 inNormal : NORMAL0, float2 inTexCoords : TEXCOORD0)
{
...
technique First
{
	pass Pass0
	{
		VertexShader = compile vs_4_0 FirstVertexShader();
